...
class Paddle(pygame.sprite.Sprite):
    def __init__(self, groups):
        ...
        pygame.draw.rect(self.shadow_surf, COLORS['paddle_shadow'], pygame.FRect((0,0),SIZE['paddle']), 0, 10)
...
class Ball(pygame.sprite.Sprite):
    def __init__(self, groups, paddle_sprites, update_score):
        ...
        self.shadow_surf = self.image.copy()
        pygame.draw.circle(self.shadow_surf,COLORS['ball_shadow'],(SIZE['ball'][0]/2,SIZE['ball'][1]/2),SIZE['ball'][0]/2)
